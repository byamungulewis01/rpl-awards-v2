<template>
    <div class="relative text-center py-10 md:py-20 bg-gradient-to-r from-sky-800 to-sky-950 overflow-hidden"
      ...
      <div class="relative z-10 flex flex-col justify-center h-full">
        <div class="max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto px-4">
          ...
          <div class="mt-4 md:mt-6 animate-fade-in-up">
            <p class="text-base md:text-lg font-semibold text-white mb-3">Voting Closes In</p>
            <div class="flex justify-center">
              <div class="grid grid-cols-4 gap-2 md:gap-4">
                ...
                <div
                  ...
                  <div class="text-xl md:text-3xl lg:text-4xl font-bold text-white mb-0">{{ timeLeft.days }}</div>
                  <div class="text-xs text-sky-200 uppercase tracking-wider">Days</div>
                </div>

                <!-- Hours -->
                <div
                  class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg px-2 py-2 md:px-4 md:py-3 text-center">
                  <div class="text-xl md:text-3xl lg:text-4xl font-bold text-white mb-0">{{ timeLeft.hours }}</div>
                  <div class="text-xs text-sky-200 uppercase tracking-wider">Hours</div>
                </div>

                <!-- Minutes -->
                <div
                  class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg px-2 py-2 md:px-4 md:py-3 text-center">
                  <div class="text-xl md:text-3xl lg:text-4xl font-bold text-white mb-0">{{ timeLeft.minutes }}</div>
                  <div class="text-xs text-sky-200 uppercase tracking-wider">Minutes</div>
                </div>

                <!-- Seconds -->
                <div
                  class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg px-2 py-2 md:px-4 md:py-3 text-center">
                  <div class="text-xl md:text-3xl lg:text-4xl font-bold text-white mb-0">{{ timeLeft.seconds }}</div>
                  <div class="text-xs text-sky-200 uppercase tracking-wider">Seconds</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-6 md:mt-8 flex flex-wrap justify-center gap-2 md:gap-4 animate-fade-in-up">
            <div
              ...
              <div
                class="inline-flex items-center justify-center px-4 md:px-5 py-2 md:py-3 border border-transparent text-sm md:text-base font-medium rounded-md text-sky-800 bg-white hover:bg-gray-100 shadow-lg transition duration-300">
                1 Vote = {{ props.votePrice || 200 }} RWF
              </div>
              <button @click="scrollToCategories"
                class="flex items-center justify-center px-5 md:px-8 py-2 md:py-3 border border-transparent text-sm md:text-base font-medium rounded-md text-white bg-sky-600 hover:bg-sky-700 md:text-lg shadow-lg transition-all duration-300 hover:scale-105">
                Start Voting Now
