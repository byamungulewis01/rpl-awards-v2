        ...
        <Card>
            ...
            <CardFooter>
                <div class="text-sm text-gray-500">
                    Showing {{ filteredUsers.length }} out of
                    ...
                    <div class="grid gap-4 py-4">
                        ...
                        <div class="grid gap-2">
                            ...
                            <select id="team" v-model="form.team"
                                ...
                                <option value="AS Kigali">AS Kigali</option>
                                <option value="Police">Police</option>
                                <option value="Gorilla">Gorilla</option>
                                <option value="Gasogi United">
                                    Gasogi United
                                </option>
                                <option value="Mukura Victory Sports">
                                ...
                                <option value="Etincelles">Etincelles</option>
                                <option value="Amagaju">Amagaju</option>
                                <option value="Muhazi United">
                                    Muhazi United
                                </option>
